...
iptables -A FORWARD -p tcp  -s 10.5.0.0/24 -d 10.5.1.20 --dport 22 -j ACCEPT
#iptables -A FORWARD -p tcp --dport 2222 -s 10.5.0.0/24 -d 10.5.1.20 -j ACCEPT

#iptables -A FORWARD -p tcp --dport 22 -s 10.5.0.20 -d 10.5.1.20 -j ACCEPT
